...
import type { NodeDragEventHandler, NodeDragEventParams, NodeMouseEventHandler, NodeMouseEventParams } from 'rc-tree/lib/contextTypes';
import DropIndicator from 'rc-tree/lib/DropIndicator';
import type { BasicDataNode, DataNode, Direction, EventDataNode, FieldNames, FlattenNode, IconType, Key, KeyEntities, NodeInstance, SafeKey, ScrollTo } from 'rc-tree/lib/interface';
...
declare class Tree<TreeDataType extends DataNode | BasicDataNode = DataNode> extends React.Component<TreeProps<TreeDataType>, TreeState<TreeDataType>> {
    ...
    static TreeNode: React.FC<import("rc-tree/lib/interface").TreeNodeProps<DataNode>>;
    destroyed: boolean;
